  ...
  tags$div(
    ...
    navset_card_pill(
      ...
      nav_panel(
        ...
        tags$h6(class = "fw-semibold mt-3",
                "3-period crossover (e.g., TRT|RTR or TRR|RTR|RRT)"),
        tags$p(class = "small",
        ...
        tags$p(class = "small",
               ...
               "For Williams designs (3 sequences, 3 periods), Sequence had 3 levels. ",
               "The treatment effect estimate and its standard error were obtained identically to the ",
               "2\u00D72\u00D72 design."),
        
        tags$h6(class = "fw-semibold mt-3",
                "4-period replicate crossover (TRTR|RTRT)"),
        tags$p(class = "small",
        ...
        tags$div(
          ...
          "bear R package, SAS PROC MIXED, or Phoenix WinNonlin). ",
