    ...
    navset_card_pill(
      ...
      nav_panel(
        ...
        tags$p(class = "small",
               ...
               "from the residual mean square error of the model. ",
        ...
        tags$p(class = "small",
               "Treatment, Period, Sequence, and Subject were all entered as fixed effects. ",
               ...
               "This approach is appropriate for balanced designs (all subjects complete all periods)."),
