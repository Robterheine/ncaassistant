        ...
        card_body(
          ...
          tags$div(
            ...
            tags$ul(class = "mb-0",
              ...
              tags$li("Smaller fixes: the batch results table left out Cmax, AUC, half-life, CL/F and Vz/F in its default view; spaces around subject or treatment names created extra levels; subject counts in crossovers now include only subjects with both treatments; a failed mixed model is reported instead of silently replaced"),
