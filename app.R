        ...
        card_body(
          ...
          tags$div(
            ...
            tags$p(class = "mb-1", tags$strong("Results can differ from v1.3.0"),
                   ...
                   "with a replicate design, with treatments not named \"Reference\" and \"Test\", or with a confidence limit that rounds onto an acceptance limit, and for sample sizes of scaled methods. See the fixes below."),
            tags$ul(class = "mb-0",
