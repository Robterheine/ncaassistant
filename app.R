        ...
        card_body(
          ...
          tags$div(
            ...
            tags$ul(class = "mb-0",
              ...
              tags$li("Validation: 330 automated and 44 manual tests (was 191 and 32), including comparisons with replicateBE and PowerTOST and a check that every record reproduces")
            )
          ),
