...
This executes 360 automated tests (plus 49 manual tests defined for a running app) and generates a results CSV with environment details, per-section results, and URS traceability.
