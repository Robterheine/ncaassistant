...
- **results.xlsx**: individual NCA parameters, summary statistics, (for BE) confidence intervals and ANOVA tables, and a Checks sheet with the data quality findings and the notes shown with the results
